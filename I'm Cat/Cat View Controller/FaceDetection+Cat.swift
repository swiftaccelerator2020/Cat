//
//  FaceDetection+Cat.swift
//  I'm Cat
//
//  Created by JiaChen(: on 12/11/20.
//
...
extension CatsViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func configureVideoDataOutput(for inputDevice: AVCaptureDevice, resolution: CGSize, captureSession: AVCaptureSession) {
        ...
        let videoDataOutputQueue = DispatchQueue(label: "jiachen.cat.VisionFaceTrack")
